...
async def play(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("😈 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/MISTY_SUPORT")
                ],
            ]
        )
        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/file/a9d3ba6c14bee0866c2d0.png"
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/MISTY_SUPORTER")
                ],
            ]
        )
        requested_by = message.from_user.first_name
        ...
        try:
            ...
            while j < 6:
                ...
                toxxt += f" └ ⚡ __ᴘᴏᴡᴇʀᴇᴅ ʙʏ {BOT_NAME} aliza__\n\n"
                j += 1            
            keyboard = InlineKeyboardMarkup(
                [
                    [
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"💡 **ᴛʀᴀᴄᴋ ᴀᴅᴅᴇᴅ ɪɴ Qᴜᴇᴜᴇ**\n\n🏷 **ɴᴀᴍᴇ:** [{title[:45]}]({url})\n⏱ **ᴅᴜʀᴀᴛɪᴏɴ:** `{duration}`\n🎧 **Aliza ᴜꜱᴇʀ ʙʏ:** {message.from_user.mention}\n" \
        ...
        await message.reply_photo(
            ...
            caption=f"🏷 **ɴᴀᴍᴇ:** [{title[:45]}]({url})\n⏱ **ᴅᴜʀᴀᴛɪᴏɴ:** `{duration}`\n😍 **ꜱᴛᴀᴛᴜꜱ:** `ᴘʟᴀʏɪɴɢ`\n" \
                   +f"🎧 **Aliza ᴜꜱᴇʀ ʙʏ:** {message.from_user.mention}",
            reply_markup=keyboard
        )
        os.remove("final.png")
...
async def ytplay(_, message: Message):
    ...
    for i in message.command[1:]:
        query += " " + str(i)
    print(query)
    await lel.edit("🎵 **ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ᴀʟɪᴢᴀ ꜱᴇʀᴠᴇʀ...**")
    ydl_opts = {"format": "bestaudio[ext=m4a]"}
    try:
        results = YoutubeSearch(query, max_results=1).to_dict()
        url = f"https://youtube.com{results[0]['url_suffix']}"
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton("🔥 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/@MISTY_SUPORT"),
                InlineKeyboardButton("✨ ᴏᴡɴᴇʀ", url=f"https://t.me/Xd_Lif")
            ],
        ]
    )
    requested_by = message.from_user.first_name
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            ...
            caption = f"🏷 **ɴᴀᴍᴇ:** [{title[:25]}]({url})\n⏱ **ᴅᴜʀᴀᴛɪᴏɴ:** `{duration}`\n😍 **ꜱᴛᴀᴛᴜꜱ:** `Qᴜᴇᴜᴇᴅ ɪɴ ᴘᴏꜱɪᴛɪᴏɴ {position}`\n" \
                    + f"🎧 **ᴀʟɪᴢᴀ ᴜꜱᴇʀ ʙʏ:** {message.from_user.mention}",
                   reply_markup=keyboard,
        )
        os.remove("final.png")
        return await lel.delete()
